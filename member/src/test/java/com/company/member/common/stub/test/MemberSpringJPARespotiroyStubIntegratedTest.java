...
import com.company.member.common.exception.TestException;
...
import com.company.member.common.stub.MemberSpringJPARepositoryStub;
...
import com.company.member.infrastructure.adapter.db.jpa.member.MemberSpringJPARepository;
...
public class MemberSpringJPARespotiroyStubIntegratedTest {
    ...
    class Other {
        ...
        void setUp() {
            ...
            memberService_stub = new MemberService(memberStub, mock(PasswordEncoder.class));
        }
        ...
        void findById() {
            ...
            //when
            Member dbResult = memberSpringJPARepository.findById(dbMember.getId()).orElseThrow(() -> new TestException(TestException.NOT_FOUND));
            Member stubResult = stub.findById(stubMember.getId()).orElseThrow(() -> new TestException(TestException.NOT_FOUND));
        ...
        void findByEmail() {
            ...
            //when
            Member dbResult = memberSpringJPARepository.findByEmail(dbMember.getEmail()).orElseThrow(() -> new TestException(TestException.NOT_FOUND));
            Member stubResult = stub.findByEmail(stubMember.getEmail()).orElseThrow(() -> new TestException(TestException.NOT_FOUND));
