...
class HelpSelectControllerTest {
    ...
    class selectCheckInAndLineUp {
        static Stream<Arguments> models() {
            return Stream.of(
                    Arguments.of(CheckInFixture.createCheckInWithId(Created.create(), 1L), "체크인", "CheckIn"),
                    Arguments.of(LineUpFixture.createLineUpWithId(Created.create(), 1L), "줄서기", "LineUp")
            );
        }
