...
import com.company.checkin.place.infra.adapter.rest.kakao.KakaoStoreAPI;
...
class KakaoAPIRequestIntegratedTest {

    @Autowired
    KakaoStoreAPI kakaoAPIRequest;
    ...
    void getStoreInfo_Keyword() {
        ...
        //when
        String response = kakaoAPIRequest.getStoreInfo(KEYWORD, query, x, y);
    ...
    void getStoreInfo_Category() {
        ...
        //when
        String response = kakaoAPIRequest.getStoreInfo(CATEGORY, FD6.name(), x, y);
